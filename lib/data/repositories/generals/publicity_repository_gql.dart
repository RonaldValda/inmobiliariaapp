...
String mutationRegisterPublicity(){
  String query="";
  query=r"""
...
String mutationUpdatePublicity(){
  String query="";
  query=r"""
...
String mutationDeletePublicity(){
  String query="";
  query=r"""
