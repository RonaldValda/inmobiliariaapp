String getQueryMutationAutenticarUsuario(){
    String query=r"""
  ...
  String getQueryMutationCrearModificarUsuario(){
    String query=r"""
  ...
  String getQueryMutationModificarUsuario(){
    String query=r"""
  ...
  String getQueryObtenerUsuarioEmail(){
    String query="";
    query=r"""
  ...
  String getMutationResponderSolicitudUsuarioCalificacion(){
    String query="";
    query=r"""
  ...
  String getQueryObtenerMembresiaPagos(){
    String query="";
    query=r"""
  ...
  String getMutationRegistrarMembresiaPago(){
    String query="";
    query=r"""
  ...
  String getMutationRegistrarEmailClaveVerificaciones(){
    String query="";
    query=r"""
  ...
  String getMutationObtenerEmailClaveVerificaciones(){
    String query="";
    query=r"""
  ...
  String getQueryAutenticarUsuarioAutomatico(){
    String query="";
    query=r"""
  ...
  String getMutationBuscarUsuarioEmail(){
    String query="";
    query=r"""
  ...
  String getMutatioRegistrarUsuarioInmuebleBuscado(){
    String query="";
    query=r"""
    mutation registrarUsuarioInmuebleBuscado(
        ...
        $remates_judiciales:Boolean,$imagenes_2D:Boolean,$video_2D:Boolean,
  ...
  String getMutationModificarInmueblesBuscados(){
    String query="";
    query=r"""
  ...
  String getMutationModificarUsuarioInmueblesBuscadosPersonales(){
    String query="";
    query=r"""
  ...
  String getQueryObtenerUsuarioInmueblesBuscados(){
    String query="";
    query=r"""
  ...
  String getMutationRegistrarSolicitudInscripcionAgente(){
    String query="";
    query=r"""
  ...
  String getQueryObtenerAgentesCiudad(){
    String query="";
    query=r"""
  ...
  String getMutationActualizarInmuebleBase(){
  String query="";
  query=r"""
