...
/*Future<PickedFile> chooseImage() async{
  ...
  Future<bool> deleteImage(dynamic imageLink) async{
    bool completed=true;
    firebase_storage.Reference? ref;
    ref=firebase_storage.FirebaseStorage.instance.ref().child(imageLink);
    /*await ref.delete()
    .then((value) {
      completed=true;
      print("correcto");
  ...
  firebase_storage.Reference? ref;
      ...
      ref=firebase_storage.FirebaseStorage.instance.ref().child('images/${imagen.path}');
      await ref.putFile(File(imagen.path)).whenComplete(() async{
